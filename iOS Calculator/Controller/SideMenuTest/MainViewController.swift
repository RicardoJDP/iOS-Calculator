...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.setNavBarAppearance(tintColor: .white, barColor: UIColor(ciColor: .black))
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "CalculatorNavID")
    }
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "CalculatorNavID")
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ProfileNavID")
        case 2:
            // Movies
            self.showViewController(viewController: UINavigationController.self, storyboardId: "PaymentNavID")
        case 3:
            // Books
